...
(() => {
  ...
  const apply = () => {
    ...
    const mid = Math.round(max * 0.78 * SCALE);
    const mx  = Math.round(max * SCALE);

    root.style.setProperty('--reel-h-mid', mid + 'px');
    root.style.setProperty('--reel-h-max', mx + 'px');
  };
