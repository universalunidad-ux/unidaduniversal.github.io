...
(()=>{try{const o=()=>{const t=window.__EXP_ABS__||((t)=>t);document.querySelectorAll(".cta-strip[data-sistema]").forEach(e=>{const r=(e.dataset.sistema||"").trim(),n=(e.dataset.pdf||"").trim(),c=o=>"https://wa.me/5568437918?text="+encodeURIComponent(o),a=n?t(`PDFS/${n}.pdf`):"#",i=t("IMG/tocar.webp");e.innerHTML=`<section class="cta-toc" aria-label="Mapa de acciones"><div class="cta-toc-media"><strong class="cta-toc-title">Mapa</strong><img class="cta-toc-img" src="${i}" alt="Mapa de acciones"></div><nav class="cta-strip-inner" aria-label="Acciones rápidas"><a class="btn btn-grad-green hero-btn" href="${c(`Hola Expiriti, quiero comprar mi licencia de CONTPAQi ${r}`)}" target="_blank" rel="noopener">Compra ahora</a><a class="btn btn-grad-purple hero-btn" href="${c(`Hola Expiriti, quiero mi prueba gratis de 30 días de CONTPAQi ${r}`)}" target="_blank" rel="noopener">Prueba gratis</a><a class="btn btn-grad-blue hero-btn" href="${c(`Hola Expiriti, quiero agendar una demo de 45 min por Zoom de CONTPAQi ${r}`)}" target="_blank" rel="noopener">Demo de 45 min por Zoom</a>${n?`<a class="btn btn-ghost hero-btn cta-ghost-black" href="${a}" target="_blank" rel="noopener">Ficha técnica (PDF)</a>`:""}<a class="btn btn-ghost hero-btn cta-ghost-black" href="#caracteristicas">Resumen ficha técnica</a></nav></section>`})};"loading"===document.readyState?document.addEventListener("DOMContentLoaded",o,{once:!0}):o()}catch(o){console.warn("[main.js] cta_strip_dynamic falló",o)}})();
