...
(function(){
  ...
  //    Flechas + dots + scroll con trackpad
  // =========================================================
  (function(){
  ...
  (function(){
    $$(".carouselX").forEach(root=>{
      ...
      function offsetForGroup(i){
        // Cada grupo comienza en el primer item de ese grupo
