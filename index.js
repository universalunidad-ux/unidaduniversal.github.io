...
function setSingleLineReelTitle(cfg,title){const t=(title||"").trim(),el=cfg?.titleEl||null;if(!el)return;el.textContent=t;el.style.display="";el.removeAttribute("aria-hidden")}
