...
D.readyState==="loading"?D.addEventListener("DOMContentLoaded",autoInitOnce,{once:!0}):autoInitOnce();
            function expMobileCalcSlidesMount(){var e=$id("calc-row");if(!e)return;var t=$id("calc-slot-2"),a=$id("add-more-panel");if(!t&&!a)return;var o=$id("calc-mobile-extras");o||(o=D.createElement("div"),o.id="calc-mobile-extras",o.className="calc-mobile-extras",e.insertAdjacentElement("afterend",o));var n=!!(W.matchMedia&&W.matchMedia("(max-width:980px)").matches);n?(t&&o.appendChild(t),a&&o.appendChild(a)):(t&&e.appendChild(t),a&&e.appendChild(a))}W.addEventListener("resize",expMobileCalcSlidesMount,{passive:!0});W.addEventListener("pageshow",expMobileCalcSlidesMount,{passive:!0});W.addEventListener("calc-render",expMobileCalcSlidesMount,{passive:!0});D.readyState==="loading"?D.addEventListener("DOMContentLoaded",expMobileCalcSlidesMount,{once:!0}):expMobileCalcSlidesMount();
