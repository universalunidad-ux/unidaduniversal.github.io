...
TRY("calc_heads",()=>{const Q=s=>document.querySelector(s),C=id=>Q(id+" .calc-container")||Q(id+" .card.body")||Q(id),T=(sel)=>Q(sel)?.textContent||"",A=()=>{const p=C("#calc-primary"),s=C("#calc-secondary"),t=C("#calc-tertiary");p&&window.setCalcHead(p,{logoSrc:"IMG/comercial-premium.webp",title:"CONTPAQi Comercial PREMIUM",subtitle:"Precio",priceText:T("#tot-primary")});s&&window.setCalcHead(s,{logoSrc:"IMG/contabilidad.webp",title:"CONTPAQi Contabilidad",subtitle:"Precio",priceText:T("#tot-secondary")});t&&window.setCalcHead(t,{logoSrc:"IMG/bancos.webp",title:"CONTPAQi Bancos",subtitle:"Precio",priceText:T("#tot-tertiary")})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",A,{once:!0}):A();addEventListener("calc-render",A,{passive:!0});addEventListener("calc-recompute",A,{passive:!0});addEventListener("pageshow",A,{passive:!0})});
