...
table.innerHTML='<thead><tr><th style="text-align:left">Concepto</th><th>Importe</th></tr></thead><tbody><tr id="tr-base'+idSuffix+'"><td id="lbl-base'+idSuffix+'">Sistema | 1 usuario</td><td id="base'+idSuffix+'">$0.00</td></tr><tr id="tr-uadd'+idSuffix+'"><td id="lbl-uadd'+idSuffix+'">Usuarios adicionales</td><td id="uadd'+idSuffix+'">$0.00</td></tr><tr id="tr-disc'+idSuffix+'"><td id="lbl-disc'+idSuffix+'">Descuento (sistema)</td><td id="disc'+idSuffix+'">0% / $0.00</td></tr><tr id="tr-inst'+idSuffix+'"><td id="lbl-inst'+idSuffix+'">Instalación</td><td class="money-cell"><label class="disc-toggle"><input type="checkbox" id="instdiscOn'+idSuffix+'" checked aria-label="Aplicar -50% si es 1er servicio"><span id="inst'+idSuffix+'">$0.00</span></label></td></tr><tr id="tr-sub'+idSuffix+'"><td id="lbl-sub'+idSuffix+'">Subtotal</td><td id="sub'+idSuffix+'">$0.00</td></tr><tr id="tr-iva'+idSuffix+'"><td id="lbl-iva'+idSuffix+'">IVA (16%)</td><td id="iva'+idSuffix+'">$0.00</td></tr><tr id="tr-tot'+idSuffix+'"><td id="lbl-tot'+idSuffix+'"><strong>Total</strong></td><td id="tot'+idSuffix+'"><strong>$0.00</strong></td></tr></tbody>';
...
var instOn=instCheckbox(),showInst=!!(instOn&&instOn.checked),instCount=showInst?usuarios:0,instWord=instCount===1?"Instalación":"Instalaciones",instLabel=(instCount>0?instWord+" ("+instCount+")":"Instalación")+" • -50% si es primer servicio";
