...
TRY("calc_heads_html_real",()=>{const Q=s=>document.querySelector(s),T=s=>Q(s)?.textContent||"",A=()=>{const p=Q("#calc-primary"),slot=Q("#calc-slot-2"),t=Q("#calc-tertiary");p&&window.setCalcHead(p,{logoSrc:"IMG/comercial-premium.webp",title:"CONTPAQi Comercial PREMIUM",subtitle:"Precio",priceText:T("#tot-primary")});slot&&window.setSlotHead(slot,{logoSrc:"IMG/paquete.webp",title:"Paquete -15%",subtitle:"Integra otro sistema",priceText:""});t&&window.setCalcHead(t,{logoSrc:"IMG/contabilidad.webp",title:"CONTPAQi Contabilidad",subtitle:"Precio",priceText:T("#tot-tertiary")})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",A,{once:!0}):A();addEventListener("calc-render",A,{passive:!0});addEventListener("calc-recompute",A,{passive:!0});addEventListener("pageshow",A,{passive:!0})});
