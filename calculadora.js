...
D.readyState==="loading"?D.addEventListener("DOMContentLoaded",autoInitOnce,{once:!0}):autoInitOnce();
            function expSyncCalcDots(){var e=$id("calc-row"),t=$id("calc-mobile-dots");if(!e||!t||!(W.matchMedia&&W.matchMedia("(max-width:980px)").matches))return;var o=[].filter.call(e.children,function(t){return t&&getComputedStyle(t).display!=="none"});if(o.length<2){t.innerHTML="";return}var n=e.getBoundingClientRect(),a=0,i=1/0;o.forEach(function(e,t){var o=Math.abs(e.getBoundingClientRect().left-n.left);o<i&&(i=o,a=t)}),[].forEach.call(t.children,function(e,t){e.classList.toggle("active",t===a)})}function expMobileCalcSlidesMount(){var e=$id("calc-row");if(!e)return;var t=$id("calc-slot-2"),o=$id("add-more-panel"),n=e.getAttribute("data-cols")||"1",a=$id("calc-mobile-extras");a||(a=D.createElement("div"),a.id="calc-mobile-extras",a.className="calc-mobile-extras",e.insertAdjacentElement("afterend",a));var i=$id("calc-mobile-dots");i||(i=D.createElement("div"),i.id="calc-mobile-dots",i.className="calc-mobile-dots",a.insertAdjacentElement("beforebegin",i));var l=!!(W.matchMedia&&W.matchMedia("(max-width:980px)").matches);l?(t&&(("1"===n?a:e).appendChild(t),t.style.display="1"===n?"":"none"),o&&(("2"===n?a:e).appendChild(o),o.style.display="2"===n?"":"none")):(t&&e.appendChild(t),o&&e.appendChild(o),t&&(t.style.display="1"===n?"":"none"),o&&(o.style.display="2"===n?"":"none"));var d=[].filter.call(e.children,function(t){return t&&getComputedStyle(t).display!=="none"});if(!l||d.length<2){i.innerHTML="";return}i.innerHTML="",d.forEach(function(e,t){var o=D.createElement("button");o.type="button",o.className="calc-dot",o.setAttribute("aria-label","Ir a calculadora "+(t+1)),o.addEventListener("click",function(){e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"start"})}),i.appendChild(o)}),expSyncCalcDots()}var __expCalcDotsRAF=0;function __expCalcDotsOnScroll(){__expCalcDotsRAF||(__expCalcDotsRAF=requestAnimationFrame(function(){__expCalcDotsRAF=0,expSyncCalcDots()}))}W.addEventListener("resize",expMobileCalcSlidesMount,{passive:!0});W.addEventListener("pageshow",expMobileCalcSlidesMount,{passive:!0});W.addEventListener("calc-render",expMobileCalcSlidesMount,{passive:!0});D.readyState==="loading"?D.addEventListener("DOMContentLoaded",function(){expMobileCalcSlidesMount();var e=$id("calc-row");e&&e.addEventListener("scroll",__expCalcDotsOnScroll,{passive:!0})},{once:!0}):(expMobileCalcSlidesMount(),$id("calc-row")&&$id("calc-row").addEventListener("scroll",__expCalcDotsOnScroll,{passive:!0}));
