...
head=el=>{if(!el)return null;var h=el.querySelector(".calc-head");if(h)return h;h=D.createElement("div");h.className="calc-head";h.innerHTML='<div class="calc-head-row" style="justify-content:center"><img class="calc-syslogo" alt="" decoding="async"></div>';el.insertBefore(h,el.firstChild);return h},
